...
const legalContent: Record<string, { title: string; lastUpdated: string; sections: { heading: string; body: string }[] }> = {
  ...
  "/terms": {
    ...
    sections: [
      ...
      { heading: "Subscription & Billing", body: "Our services are offered on a monthly subscription basis. Prices are per property per month and vary by plan. You will be billed at the beginning of each billing cycle. You can cancel your subscription at any time — cancellation takes effect at the end of your current billing period." },
